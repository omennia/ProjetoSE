...
arm.write(b'H0,90,20,90,90,10,20\n')  #home the arm at low speeds
time.sleep(2)
# print("Gouin 45 degrees")
# write_arduino([45,20,90,90,90,73])  #write the home position to the arm
# # arm.write(b'H0,45,20,90,90,73,200\n')  #write the home position to the arm
# # write_position(45,0,90,90,90,"open")  #write the home position to the arm
# time.sleep(1)
# print("Gouin 90 degrees")
# write_arduino([90,20,90,90,90,73])  #write the home position to the arm
# time.sleep(1)
# print("Gouin 135 degrees")
# write_arduino([135,20,90,90,90,73])  #write the home position to the arm
# time.sleep(1)
# print("Gouin 90 degrees")
# write_arduino([90,20,90,90,90,73])  #write the home position to the arm
# # arm.write(b'H0,90,20,90,90,73,200\n')  #write the home position to the arm
# # write_position(90,0,90,90,90,"open")  #write the home position to the arm
